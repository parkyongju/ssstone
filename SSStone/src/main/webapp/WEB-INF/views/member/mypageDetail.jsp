          ...
          <div class="col-12">
            ...
            <ol class="breadcrumb mb-0 font-size-xs text-gray-400">
              ...
              <li class="breadcrumb-item"><a class="text-gray-400" href="/member/mypage?m_no=${m_no}"> My Page</a></li> 
                <li class="breadcrumb-item active"><a class="text-gray-400" href="/member/mypageDetail?m_no=${m_no}">Order Detail</a></li>       
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center">
            ...
            <!-- Heading -->
            <h3 class="mb-10">Order Detail</h3>
          </div>
        </div>
                  ...
                  <div class="card-body bg-light">
                    <div class="row" style="margin-bottom: 15px;">
                      ...
                      <div class="col-6 col-lg-6">
                        ...
                        <!-- Text -->
                        <p class="mb-0 font-size-sm font-weight-bold">
                          <fmt:formatNumber value="${mypage.p_price}" pattern="#,###"/>원<i class="fe fe-x"></i><c:out value="${mypage.s_amount}" />개                       
                        </p>
                      </div>
                        ...
                        <!-- Text -->
                        <p class="mb-0 font-size-sm font-weight-bold">                          
                          <fmt:formatNumber value="${mypage.purchaseAmount}" pattern="#,###"/>원 
                        </p>
                      </div>
                    ...
                    <div class="row align-items-center">            
                      <div class="col">
                        ...
                        <p class="mb-4 font-size-sm font-weight-bold" title="해당상품으로 이동">
                          <a class="text-body" href="/product/product?p_no=${mypage.p_no}">상품보러가기</a><br>
                          <span class="text-muted">상품옵션 : </span>                         
                        </p>
                        <!-- Text -->
                        <div class="font-size-sm text-muted">
                          <c:out value="${mypage.p_option }" /><br>                                                    
                        </div>
                      </div>
                    </div>
                  </li>        
