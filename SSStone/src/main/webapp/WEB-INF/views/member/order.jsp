                  ...
                  <div class="card-body bg-light">
                    ...
                    <div class="row" style="margin-bottom: 15px;">   
                      ...
                      <div class="col-7 col-lg-4">                  
                        ...
                        <!-- Text -->
                        <p class="mb-lg-0 font-size-sm font-weight-bold">                   
                         <fmt:formatDate value="${order.pc_date}" pattern="yyyy/MM/dd"/>                         
                        </p>
                      </div>
                      ...
                      <div class="col-9 col-lg-10">
                        ...
                        <p class="mb-0 font-size-sm font-weight-bold">
                         <c:out value="${order.m_address1}" />   <c:out value="${order.m_address2}" />   <c:out value="${order.m_address3}" />   
                        </p>
                      </div>
                      </div>
                    ...
                    <div class="form-row">
                      <div class="col-8">                   
                        <!-- Button -->
                        <a class="btn btn-lg btn-block btn-outline-dark" href="/member/orderDetail?pc_no=${order.pc_no}" title="상품자세히보기">                        
                        Order Details
                        </a>
                        <!-- Button end-->
                      </div>    
