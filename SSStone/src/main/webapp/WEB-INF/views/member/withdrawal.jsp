...
<!-- Breadcrumb -->
     <ol class="breadcrumb mb-0 font-size-xs text-gray-400">
       ...
       <li class="breadcrumb-item"><a class="text-gray-400" href="/member/mypage?m_no=${m_no}"> My Page</a></li> 
         <li class="breadcrumb-item active"><a class="text-gray-400" href="/member/withdrawal?m_no=${m_no}">My Withdrawal</a></li>       
     </ol>
     <!-- BREADCRUMB end-->
            ...
            <nav class="mb-10 mb-md-0">
              ...
              <a class="list-group-item list-group-item-action dropright-toggle " href="/member/mypage?m_no=${m_no}">
                ...
                <a class="list-group-item list-group-item-action dropright-toggle" href="/payment/shopcart?m_no=${m_no}">
                 ...
                 <a class="list-group-item list-group-item-action dropright-toggle active" href="/member/withdrawal?m_no=${m_no}">
                  회원 탈퇴
                </a>
              </div>
            </nav>
                     ...
                     <div class="row">
                        <div class="col-12">
                           ...
                           <div class="form-group">
                            <input class="form-control form-control-sm" name="username" id="loginEmail" type="email" value='ID : <c:out value="${member.m_email }" />' readonly="readonly">                            
                           </div>
                        </div>
                        <div class="col-12">
                           <!-- Password -->
